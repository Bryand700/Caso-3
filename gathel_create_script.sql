/*==============================================================
  ...
  Script de creación de base de datos, tablas, constraints e índices
==============================================================*/

IF DB_ID(N'Gathel - Gaming the life') IS NULL
BEGIN
    CREATE DATABASE [Gathel - Gaming the life];
END;
GO
...
/*==============================================================
  Limpieza opcional para reejecutar el script
==============================================================*/

DROP TABLE IF EXISTS dbo.aiFindings;
DROP TABLE IF EXISTS dbo.aiResponses;
DROP TABLE IF EXISTS dbo.aiRequests;
DROP TABLE IF EXISTS dbo.aiExecutions;
DROP TABLE IF EXISTS dbo.aiFindingTypes;
DROP TABLE IF EXISTS dbo.severityLevels;
DROP TABLE IF EXISTS dbo.aiValidationResultTypes;
DROP TABLE IF EXISTS dbo.aiExecutionStatusTypes;
DROP TABLE IF EXISTS dbo.aiAgents;

DROP TABLE IF EXISTS dbo.redemptions;
DROP TABLE IF EXISTS dbo.merchantProducts;
DROP TABLE IF EXISTS dbo.merchants;

DROP TABLE IF EXISTS dbo.auditLogs;
DROP TABLE IF EXISTS dbo.auditActionTypes;
DROP TABLE IF EXISTS dbo.changeSources;

DROP TABLE IF EXISTS dbo.propositionResult;
DROP TABLE IF EXISTS dbo.propositionResultTypes;

DROP TABLE IF EXISTS dbo.predictionSettlements;
DROP TABLE IF EXISTS dbo.predictionResults;
DROP TABLE IF EXISTS dbo.predictionStakeHistories;
DROP TABLE IF EXISTS dbo.predictionStakes;
DROP TABLE IF EXISTS dbo.predictions;
DROP TABLE IF EXISTS dbo.settlementStatusTypes;
DROP TABLE IF EXISTS dbo.predictionTypes;

DROP TABLE IF EXISTS dbo.propositionStatusHistories;
DROP TABLE IF EXISTS dbo.propositionVotes;
DROP TABLE IF EXISTS dbo.propositions;
DROP TABLE IF EXISTS dbo.propositionStatus;

DROP TABLE IF EXISTS dbo.resources;
DROP TABLE IF EXISTS dbo.resourceTypes;
DROP TABLE IF EXISTS dbo.playerSocialNetworkTokens;
DROP TABLE IF EXISTS dbo.playersSocialNetwork;
DROP TABLE IF EXISTS dbo.socialNetworks;

DROP TABLE IF EXISTS dbo.paymentAttempts;
DROP TABLE IF EXISTS dbo.moneyBalance;
DROP TABLE IF EXISTS dbo.paymentMethods;
DROP TABLE IF EXISTS dbo.paymentOperationTypes;
DROP TABLE IF EXISTS dbo.paymentTransactionsStatus;
DROP TABLE IF EXISTS dbo.providers;

DROP TABLE IF EXISTS dbo.transactions;
DROP TABLE IF EXISTS dbo.transactionTypes;
DROP TABLE IF EXISTS dbo.balances;
DROP TABLE IF EXISTS dbo.currencyConfigurations;

DROP TABLE IF EXISTS dbo.historicalExchangeRates;
DROP TABLE IF EXISTS dbo.currentExchangeRates;
DROP TABLE IF EXISTS dbo.exchangePairs;
